...
entername2:
MovCursorToLocation 3,7
ReadString player2name
MovCursorToLocation 3,10
displaystring MSG_CLEAR

cmp player2name+2[1],41H
jb printerror2
cmp player2name+2[1],7AH
ja printerror2
jmp endname
printerror2:
MovCursorToLocation 3,10
...
UPDATECURSORLOCATIONRIGHT MACRO
  PUSHA
  mov ah,3h
mov bh,0 
int 10h
...
CALL CHECK_PROC_P1 
START_TRAVERSAL_CHECK:

MemoryToMemoryMovWord GLOBAL_COLUMN,Array_Of_Possible_Moves_For_Check_P1[DI]
 add DI,2 

 MemoryToMemoryMovWord GLOBAL_ROW,Array_Of_Possible_Moves_For_Check_P1[DI]
 add DI,2 
  ...
  je  found_check 
DEC Number_of_Cells_In_Array_Of_Check_p1
JNZ START_TRAVERSAL_CHECK

jmp skip_found_check
found_check:

 MovCursorToLocation 23,254
displaystring mes_check
skip_found_check:
...
CMP  AX ,  P2_GLOBAL_CELL[10]   ;NEW
 ...
 MovCursorToLocation 32,20
 displaystring mes_Timer
 ;*************BELL SOUND IF TIMER NOT FINISHED YET****************
; EnterTextMode
;  PUSH DX
;  PUSH AX
;  mov ah,2
...
CALL InitPiecesPROC
   ...
   SKIP_UP:                      CMP                   AL,DOWN_AsciiCode
                                 JE                    DOWN
                                 JMP                   SKIP_DOWN
   DOWN:                         
                              CALL    DOWN_PRESSED_PROC
   SKIP_DOWN:                    
                                 CMP                   AL, Right_AsciiCode
                                 JE                    RIGHT
                                 JMP                   SKIP_RIGHT
   RIGHT:              
